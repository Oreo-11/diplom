...
export default function ManagingTheWorkWeek({ auth, laravelVersion, phpVersion }) {
    ...
    let [userRecotd, setUserRecord] = useState(0);
    ...
    if(token != 0 && type != "client") {
        useEffect(() => {
            ...
            if(item != 0) {
                //доделай тут убери 9 и поставь кого нужно
                const apiUrlUserWeek = 'http://127.0.0.1:8000/api/workWeek/' + userRecotd;
        ...
        <section className="name_page">
            <h1>Расписание специалистов на месяц</h1>
        </section>
